...
void UART0_IRQHandler(void)
{
    ...
    UART_Put_Buff(UART0,data,20);      //就发送出去
}
void UART1_IRQHandler(void)
{
    ...
    UART_Put_Buff(UART1,data,20);      //就发送出去
}
void UART2_IRQHandler(void)
{
    ...
    UART_Put_Buff(UART2,data,100);      //就发送出去
}
void UART3_IRQHandler(void)
{
    ...
    UART_Put_Buff(UART3,data,20);      //就发送出去
}
void UART4_IRQHandler(void)
{
    ...
    UART_Put_Buff(UART4,data,20);      //就发送出去
...
void UART5_IRQHandler(void)
{
    ...
    UART_Put_Buff(UART5,data,20);      //就发送出去
}
